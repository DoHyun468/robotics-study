...
*석사 계측 과제의 두 기둥 — 내부는 ray로, 외부는 1D로 — 그 이론적 근거가 된 논문들. 네 편 모두 PDF 원문을 직접 읽고 정리했다.*
...
| [1D Target Calibration](1d-calibration.md) | 현장에서 대형 2D 보드를 못 쓰면? → **막대 하나로 언제 캘리브레이션이 가능한가** | Zhang (MSR-TR-2001-120 / TPAMI 2004) |
