...
<p class="rs-foot">
스택: MuJoCo(Franka Panda) · WSL2/RTX 4090 · 고전 파이프라인(기하 perception + DLS IK + PD 제어) + 학습(GraspNet · OpenVLA · …). 논문 리뷰는 <a class="reference internal" href="reviews/index.html">Reviews</a>. 개인 스터디 — 회사와 무관.
</p>
