...
<img src="_static/vla_dex2.png" alt="dexterous 16-DoF Allegro VLA data — grasp obs, 16-joint action trace, joint heatmap" style="width:100%;max-width:1150px;border-radius:8px">
